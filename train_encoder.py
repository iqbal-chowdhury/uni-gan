...
def load_data() :
	tr_coco_captions = pickle.load(open(os.path.join(dataDir, 'train', 'coco_tv.pkl'), "rb"))
	# h1 = h5py.File(join(data_dir, 'flower_tc.hdf5'))
	tr_img_classes = pickle.load(open(os.path.join(dataDir, 'train', 'coco_tc.pkl'), "rb"))
	
	val_coco_captions = pickle.load(open(os.path.join(dataDir, 'val', 'coco_tv.pkl'), "rb"))
	# h1 = h5py.File(join(data_dir, 'flower_tc.hdf5'))
	val_img_classes = pickle.load(open(os.path.join(dataDir, 'val', 'coco_tc.pkl'), "rb"))
	...
	return tr_coco_captions, tr_img_classes, val_coco_captions, val_img_classes, \
